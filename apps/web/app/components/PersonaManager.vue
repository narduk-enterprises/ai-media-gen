  ...
  <section class="mb-10">
    <div class="flex items-center justify-between mb-3">
      ...
      <div class="flex items-center gap-3">
        <button
class="text-xs font-medium transition-colors" :class="showPersonaImport ? 'text-violet-600' : 'text-slate-400 hover:text-slate-600'"
    ...
    <div v-else class="overflow-x-auto pb-2">
      <div class="inline-flex gap-3">
        <button
v-for="person in persons" :key="person.id" class="shrink-0 w-52 p-3 rounded-xl border-2 text-left transition-all"
