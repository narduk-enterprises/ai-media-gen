...
const QUICK_DEPLOY_PRESETS: QuickDeployPreset[] = [
  ...
  { id: 'wan22_t2v', label: 'Wan 2.2 T2V Slim', icon: '⚡🎬', description: 'Text-to-video only — no I2V, fast deploy', modelGroups: ['wan22_t2v', 'upscale'], minVram: 48, color: 'from-sky-500 to-indigo-600', isVideo: true },
